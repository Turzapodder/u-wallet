                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Procedure(text: "Take Birth Certificate\n Photo", userType: userType,size: 18),
                                SizedBox(
                                  height: 30,
                                ),
                                Procedure(text: "Fill up other information", userType: userType,size: 18),
                                SizedBox(
                                  height: 30,
                                ),
                                Procedure(userType: userType, text: "Take a selfie of yours", size: 18,),
                              ],
                            ),
                          ),
                        ),
