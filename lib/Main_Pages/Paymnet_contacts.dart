...
class Payment_contactState extends State<Payment_contact> {
  ...
  Future<void> _showContactInfo(Contact contact) async {
    String? fieldValue = await getFieldByValue(Phone!);
  ...
  Future<String?> getFieldByValue(String searchValue) async {
    try {
      ...
      // Query the collection for documents with the matching field and value
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        return documentSnapshot.get('userType') as String?;
      } else {
        return null;
      }
    } catch (e) {
